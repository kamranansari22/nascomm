                    ...
                    <div className="container-main">
                        <div className="box-14-1">
                            <div className="row ps-6 justify-content-end">
                                <div className="col-md-3 col-sm-6 col-6">
                                    <div className="box-12 wobble-horizontal text-center">
                                        <img src="assests/img/case 1.png" alt="case" />
                                        <p>Study & Reports</p>
                                    </div>
                                </div>
                                <div className="col-md-3 col-sm-6 col-6">
                                    <div className="box-12 wobble-horizontal text-center">
                                        <img src="assests/img/case 2.png" alt="case-2" />
                                        <p>Whitepapers</p>
                                    </div>
                                </div>
                            </div>
                            <div className="row mt-sm-4 ps-6 justify-content-end box-14-2">
                                <div className="col-md-3 col-sm-6 col-6">
                                    <div className="box-12 wobble-horizontal text-center">
                                        <img src="assests/img/case 2(3).png" alt="case-3" />
                                        <p>News letters</p>
                                    </div>
                                </div>
                                <div className="col-md-3 col-sm-6 col-6">
                                    <div className="box-12 wobble-horizontal text-center">
                                        <img src="assests/img/case 2(2).png" alt="case-4" />
                                        <p>Point of view</p>
                                    </div>
                                </div>
                                <div className="col-md-3 col-sm-6 col-12">
                                    <div className="box-12 wobble-horizontal text-center">
                                        <img src="assests/img/case 2(1).png" alt="case-5" />
                                        <p>Advisories</p>
                                    </div>
                                </div>
                            </div>
