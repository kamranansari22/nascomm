                            ...
                            <div className="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    ...
                                    <div className="col-md-6  d-flex align-items-stretch">
                                        <div className="box-3 float">
                                            <div className="row h-100">
                                                <div className="col-md-5 col-sm-5"><img src={process.env.PUBLIC_URL + "/assests/img/event1.png"} alt="Event1" /></div>
                                                <div className="col-md-7 col-sm-7">
                                                    <div className="w-100 box-3-box">
                                                        ...
                                                        <div className="s-arrow float-end mb-4"><Link to='excellence-award'><img src={process.env.PUBLIC_URL + "/assests/img/Vector8.png"} alt="Vector8" /></Link></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="row h-100">
                                                ...
                                                <div className="col-md-7 col-sm-7 pr-3">
                                                    <div className="w-100 box-3-box">
                                                        ...
                                                        <div className="s-arrow float-end mb-4"><Link to='/hackathon'><img src={process.env.PUBLIC_URL + "/assests/img/Vector8.png"} alt="Vector" /></Link></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div className="row row-eq-heigh">
                                    <div className="col-md-6  d-flex align-items-stretch">
                                        <div className="box-3 float">
                                            <div className="row">
                                                <div className="col-md-5 col-sm-5 "><img src={process.env.PUBLIC_URL + "/assests/img/event3.png"} alt="event3" /></div>
                                                <div className="col-md-7 col-sm-7">
                                                    <div className="w-100 box-3-box">
                                                        <div className="award">Awards</div>
                                                        ...
                                                        <div className="s-arrow float-end mb-4"><Link to='/excellence-award'><img src={process.env.PUBLIC_URL + "/assests/img/Vector8.png"} alt="VTR8" /></Link></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-md-6  d-flex align-items-stretch">
                                        <div className="box-3 float">
                                            <div className="row">
                                                <div className="col-md-5 col-sm-5"><img src={process.env.PUBLIC_URL + "/assests/img/event4.png"} alt="event4" /></div>
                                                <div className="col-md-7 col-sm-7 pr-3">
                                                    <div className="w-100 box-3-box">
                                                        <div className="awards-grn">Hackathon</div>
                                                        ...
                                                        <div className="s-arrow float-end mb-4"><Link to='/hackathon'><img src={process.env.PUBLIC_URL + "/assests/img/Vector8.png"} alt="VETOR" /></Link></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div className="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                                <div className="row row-eq-heigh">
                                            ...
                                            <div className="row ">
                                                ...
                                                <div className="col-md-7 col-sm-7">
                                                    <div className="w-100 box-3-box">
                                                        ...
                                                        <h4>Indian pharma takes the digital leap - What does it mean for cybersecurity?</h4>
                                                        <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard...</p>
                                                        <div className="s-arrow float-end mb-3"><img src={process.env.PUBLIC_URL + "/assests/img/Vector8.png"} alt="VT8" /></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="col-md-6  d-flex align-items-stretch">
                                        <div className="box-3 float">
                                            <div className="row">
                                                <div className="col-md-5 col-sm-5"><img src={process.env.PUBLIC_URL + "/assests/img/event2.png"} alt="event2" /></div>
                                                <div className="col-md-7 col-sm-7 pr-3">
                                                    <div className="w-100 box-3-box">
                                                        <div className="awards-grn">Hackathon</div>
                                                        ...
                                                        <h4>Cyber Resilient Business Environment – A DSCI-Dell Point of View Paper</h4>
                                                        <p>The shrinking sophistication, frequency, and severity of cyber-attacks targeting organizations highlights...</p>
                                                        <div className="s-arrow float-end mb-3"><img src={process.env.PUBLIC_URL + "/assests/img/Vector8.png"} alt="VR8" /></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-md-7 col-sm-7">
                                                    <div className="w-100 box-3-box">
                                                        ...
                                                        <h4>Getting your cloud Strategy Right | DSCI-Tata Communications PoV</h4>
                                                        <p>With cloud gaining prominence across the sectors on the back of its numerous benefits, DSCI and Tata Communications...</p>
                                                        <div className="s-arrow float-end mb-4"><img src={process.env.PUBLIC_URL + "/assests/img/Vector8.png"} alt="VE8" /></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-md-7 col-sm-7 pr-3">
                                                    <div className="w-100 box-3-box">
                                                        ...
                                                        <h4>DarkSide Ransomware Attack on Colonial Pipeline</h4>
                                                        <p>Colonial pipeline company faced ransomware attack by DarkSide group. The DarkSide ransomware attack is a part...</p>
                                                        <div className="s-arrow float-end mb-4"><img src={process.env.PUBLIC_URL + "/assests/img/Vector8.png"} alt="V8" /></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
